...
public class Task4Test extends WebDriverSettings{
    @Test
    public void Task4(){
       ...
       /* driver.findElement(By.xpath
        ...
        driver.findElement(By.cssSelector
                ("//*[@id=\"__ozon\"]/div/div[1]/div[3]/div[2]/div[1]/div/aside/div[10]/div[2]/div[2]/div[1]/input")).sendKeys(Keys.RETURN);
        try {
            Thread.sleep(1500);
        } catch (InterruptedException e) {
            e.printStackTrace();
       ...
       // driver.findElement(By.xpath("//*[@id=\"__ozon\"]/div/div[1]/div[3]/div[2]/div[1]/div/aside/div[10]/div[2]/div[2]/div[1]/input")).click();
        try {
            Thread.sleep(4000);
        } catch (InterruptedException e) {
            e.printStackTrace();
